...
public class Zone {
	...
	private Collection<Mib> getMibs() {
	...
	/**
	 * @return the a copy of the child zones of this zone
	 */
	...
	private void relativeAdd(String aPath, Zone aZone) {
		...
		if (myNextSep == -1) {
			...
			if (myChild == null) {
				 ...
				 */
				Mib myMib = new Mib(aZone.getMib().getRepresentative());				
				myChild.add(myMib);
	...
	public void dumpTree(Zone aZone, String anIndent) {
		...
		System.out.println(anIndent + myName + ": " + aZone.getMib().getIssued() + ", " + 
				...
				aZone.getMib().getRepresentative() + ", " + aZone.isSelf());
